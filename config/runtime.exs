...
#
#     PHX_SERVER=true bin/otr_bunq start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :otr_bunq, OtrBunqWeb.Endpoint, server: true
end

config :otr_bunq,
  bunq_user_id: System.get_env("BUNQ_USER_ID"),
...
if config_env() == :prod do
  ...
  config :otr_bunq, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :otr_bunq, OtrBunq.Mailer,
